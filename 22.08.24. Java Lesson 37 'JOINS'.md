...
In SQLite (as well as in other relational database management systems), relationships refer to the associations between tables based on common columns. 
...
Here’s an overview of the different types of relationships in SQLite:
