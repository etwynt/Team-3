...
pokemon_df['Name_length'] = pokemon_df['Name_no_spaces'].apply(len)

max_name_length = pokemon_df['Name_length'].max()
longest_pokemon = pokemon_df[pokemon_df['Name_length'] == max_name_length]['Name'].iloc[0]

print(f"The Pokemon with the longest name: {longest_pokemon}")
```
